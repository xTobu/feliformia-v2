                ...
                <template #item="{ element: option }">
                    <div class="option-item">
                        <div class="option-left">
                            ...
                            <el-tag v-if="option.has_time_range" size="small" type="info">
                                需填時間
                            </el-tag>
                            <el-tag v-if="!option.is_active" size="small" type="danger">
                                已停用
                            </el-tag>
                        </div>
            ...
            >
                <el-form :model="form" label-width="100px" @submit.prevent>
                    <el-form-item label="選項名稱">
                        <el-input v-model="form.name" placeholder="例如：醫療" />
                    </el-form-item>
...
async function onDragEnd() {
    ...
    // 逐一更新（Supabase 不支援批次 upsert 不同 id）
...
async function saveOption() {
    ...
    if (editingOption.value) {
        ...
        // 新增
        const maxOrder = options.value.length > 0
